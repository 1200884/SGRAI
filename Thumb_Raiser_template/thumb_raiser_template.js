    ...
    keyChange(event, state) {
        ...
        if (document.activeElement == document.body) {
            ...
            /* To-do #41 - Toggle the user interface visibility
                ...
                - state: true*/
            if (this.player.keyCodes.userInterface==event.code&& state) { // Display / hide user interface
...
*/
                    ...
                    if (this.player.keyStates.backward) { // The player is moving backward
                         const newPosition = new THREE.Vector3(-coveredDistance*Math.sin(direction), 0, -coveredDistance*Math.cos(direction)).add(this.player.position);
                    ...
                    /* To-do #21 - If the player is not moving nor emoting, then trigger the idle action
                        ...
                        this.animations.fadeToAction("Idle",0.2, this.animations.activeName != "Death" ? "Idle" : 0.6,0.2);
                    } 
