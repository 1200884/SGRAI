...
export default class Pong extends THREE.Group {
    ...
    keyChange(event, state) {
        ...
        if(event.code==this.player1.keyCodes.left){
            this.player1.keyStates.left= state;
        }
        if(event.code==this.player2.keyCodes.left){
            this.player2.keyStates.left= state;
        }
        if(event.code==this.player1.keyCodes.right){
            this.player1.keyStates.right= state;
        }
        if(event.code==this.player2.keyCodes.right){
            this.player2.keyStates.right= state;
        }
    ...
    update() {
        ...
        if (!this.gameRunning) {
            ...
            if (!this.gamePaused) {
                ...
                <tr><td>Size:</td><td>" + this.player1.size.y.toFixed(2) + "</td><td>Direction:</td><td>" + THREE.MathUtils.radToDeg(this.ball.direction).toFixed(2) + "°</td><td>Spin:</td><td>" + this.ball.spin + "</td><td>Size:</td><td>" + this.player2.size.y.toFixed(2) + "</td></tr>";
    ...
    */
                ...
                if (this.ball.center.x>this.table.halfSize.x) { // Player 1 scored
                    ...
                    this.ball.speed = 1;
                    this.displayScore();
                    this.player1.speed*=1.07;
                   // this.player1.size.y-=this.sizeIncrement;
                    ...
                    this.displayScore();
                    this.player2.speed*=1.07;
                    //this.player2.size.y-=this.sizeIncrement;
