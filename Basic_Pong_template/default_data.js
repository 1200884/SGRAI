...
export const playerData = {
    ...
    keyCodes: { down: "ArrowDown", up: "ArrowUp",left: "ArrowLeft",right:"ArrowRight" } // Arrow keys; MUST BE REDEFINED when creating an instance of Pong() so that each player is assigned a different set of keys
}
